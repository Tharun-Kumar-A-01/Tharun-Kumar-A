  ...
  return (
    <div className="flex  min-h-screen py-2 ">
      <div className=" ml-20">
        ...
        <h1 className='text-5xl font-bold py-1'>I am <span className="text-primary">Tharun Kumar</span></h1>
        ...
        <div className="flex mt-2">
          <Button className={`${jetBrainsMono.className} text-background font-bold`} color='primary'>Lets Connect {" ~~>"}</Button>
          <Button className="ml-2 h-10" as={Link} variant='bordered' color='primary' showAnchorIcon href='/'>
